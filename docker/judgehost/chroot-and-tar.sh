...
mkdir -p /chroot/domjudge/usr/local/lib
unzip -q /tmp/kotlin-compiler.zip -d /chroot/domjudge/usr/local/lib/
rm /tmp/kotlin-compiler.zip

# Create symlinks for kotlin binaries in chroot
mkdir -p /chroot/domjudge/usr/local/bin
ln -sf /usr/local/lib/kotlinc/bin/kotlinc /chroot/domjudge/usr/local/bin/kotlinc
ln -sf /usr/local/lib/kotlinc/bin/kotlin /chroot/domjudge/usr/local/bin/kotlin
